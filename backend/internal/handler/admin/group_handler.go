...
type CreateGroupRequest struct {
	...
	CodexServiceTierMode        string                                    `json:"codex_service_tier_mode" binding:"omitempty,oneof=follow_upstream force_fast disallow_fast"`
...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	group, err := h.adminService.CreateGroup(c.Request.Context(), &service.CreateGroupInput{
		...
		CodexServiceTierMode:            req.CodexServiceTierMode,
