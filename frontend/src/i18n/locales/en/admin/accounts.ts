export default {
    accounts: {
      ...
      openaiQuotaReset: {
        ...
        schedule: 'Schedule',
        scheduleTitle: 'Schedule usage reset',
        scheduleTooltipReady: 'Create a one-time task for the earliest expiring reset credit',
        scheduleTooltipNeedQuery: 'Click Credits first to load expiration details',
        scheduleTooltipNoExpiry: 'No expiration detail is available for scheduling',
        scheduleTooltipUnavailable: 'The current reset credit is expired or unavailable',
        scheduleTooltipShadow: 'Spark shadow accounts cannot schedule reset tasks',
        scheduleTooltipExisting: 'View the existing reset task',
        ...
        oneHour: '1 hour',
        minutes: '{count} min',
        createSchedule: 'Create task',
        scheduleCreated: 'Reset task created',
        scheduleAlreadyExists: 'A reset task already exists for this credit',
        scheduleCanceled: 'Reset task canceled',
        retryQueued: 'The original idempotent request was queued again',
        retry: 'Retry task',
