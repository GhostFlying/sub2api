export default {
    accounts: {
      ...
      openaiQuotaReset: {
        ...
        schedule: '计划',
        scheduleTitle: '计划重置任务',
        scheduleTooltipReady: '为最早到期的重置次数创建一次性任务',
        scheduleTooltipNeedQuery: '先点击「次数」加载重置次数到期时间',
        scheduleTooltipNoExpiry: '没有可用于计划任务的到期明细',
        scheduleTooltipUnavailable: '当前重置次数已过期或不可计划',
        scheduleTooltipShadow: 'Spark 影子账号不能创建重置任务',
        scheduleTooltipExisting: '查看已创建的重置任务',
        creditExpiry: '次数到期',
        executeAt: '执行时间',
        ...
        minutes: '{count} 分钟',
        createSchedule: '确认创建',
        scheduleCreated: '已创建重置任务',
        scheduleAlreadyExists: '该次数已有重置任务',
        scheduleCanceled: '已取消重置任务',
        retryQueued: '已使用原幂等请求重新排队',
        retry: '重试原任务',
        taskStatus: '任务状态',
        dispatches: '请求次数',
        taskStatuses: {
